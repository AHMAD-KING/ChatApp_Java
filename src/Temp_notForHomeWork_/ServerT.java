 ...
 * @author MyPC
 */
public class ServerT extends javax.swing.JFrame {
            ...
            Thread tcpServer = new Thread(new Runnable() {
                ...
                public void run() {
                    while (true) {
                        ...
                        if(!cData.equals(lastAdded))serverOnline.append(cData+"\n");
...
//               throw new UnsupportedOperationException("Not supported yet."); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/GeneratedMethodBody
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ServerT.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
