 ...
 * @author MyPC
 */
public class serverTCP_DeleteED extends javax.swing.JFrame {
                    ...
                    while (true) {
                        ...
                        if (flag != 2) {
                            try {
                                ...
                                Logger.getLogger(serverTCP_DeleteED.class.getName()).log(Level.SEVERE, null, ex);
                            }
                        }
                        lastAdded = cData;
                        ...
                        for (int i = 0; i < Users.size(); i++) {
                            check = Users.get(i).split(",")[2];
                            av = serverTCP_DeleteED.isPortAvailable(Integer.parseInt(check));
                            if (av == false) {
                                Users.remove(i);
                                nav = 1;
                            }
                        }
//                        check = cData.split(",")[0].replaceAll("\\s", "");
//                        System.out.println(check);
//                        if (check.equals("delete")) {
//                            checkport = cData.split(",")[2].replaceAll("\\s", "");
//                            for (int i = 0; i < Users.size(); i++) {
//                                if (Users.get(i).split(",")[2].equals(checkport)) {
//                                    Users.remove(i);
//                                    serverOnline.setText(" ");
//                                    try {
//                                        Thread.sleep(1000);
...
//                            }
//                            for (int i = 0; i < Users.size(); i++) {
//                                serverOnline.append(Users.get(i) + "\n");
//                            }
//                        } else 
                        if (nav == 1) {
                            serverOnline.setText(" ");
...
//               throw new UnsupportedOperationException("Not supported yet."); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/GeneratedMethodBody
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(serverTCP_DeleteED.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new serverTCP_DeleteED().setVisible(true);
            }
        });
    }
